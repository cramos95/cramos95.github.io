...
var style_Wind_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value > 3.000000 && value <= 57.000000) {
        ...
        image: new ol.style.Circle({radius: 2.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(0,0,0,0.796078431373)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(50,205,50,0.796078431373)'})}),
